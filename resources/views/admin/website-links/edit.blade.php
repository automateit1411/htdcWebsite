...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <h1 class="text-2xl font-bold text-gray-800">Edit Website Link</h1>
        <a href="{{ route('admin.website-links.index') }}" class="text-gray-500 hover:text-gray-700">Back to List</a>
    </div>
