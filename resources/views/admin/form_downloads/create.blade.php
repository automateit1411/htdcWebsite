...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <h1 class="text-2xl font-bold text-gray-800">Create formDownload</h1>
        ...
        <form action="{{ route('admin.form-downloads.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <ul class="text-xs text-blue-800 space-y-1">
                    ...
                    <li>• <strong>New</strong>: form-downloads created within the last 7 days</li>
                    <li>• <strong>Old</strong>: form-downloads older than 7 days</li>
