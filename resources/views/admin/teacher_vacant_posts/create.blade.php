...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <h1 class="text-2xl font-bold text-gray-800">Create teacherVacantPost</h1>
        ...
        <form action="{{ route('admin.teacher-vacant-posts.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <ul class="text-xs text-blue-800 space-y-1">
                    ...
                    <li>• <strong>New</strong>: teacher-vacant-posts created within the last 7 days</li>
                    <li>• <strong>Old</strong>: teacher-vacant-posts older than 7 days</li>
                    <li>• A "New" badge with animated GIF will appear on the website for new teacher-vacant-posts</li>
                </ul>
            </div>
