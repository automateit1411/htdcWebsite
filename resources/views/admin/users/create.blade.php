            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select name="role" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#3dab8c] focus:ring-[#3dab8c] sm:text-sm" required>
                        <option value="3" {{ old('role') == 3 ? 'selected' : '' }}>Viewer (Read-only)</option>
                        <option value="2" {{ old('role') == 2 ? 'selected' : '' }}>Editor (Add/Edit data)</option>
                        <option value="1" {{ old('role') == 1 ? 'selected' : '' }}>Administrator (Full control)</option>
                    </select>
