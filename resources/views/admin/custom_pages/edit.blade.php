...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex justify-between items-center">
        <h1 class="text-2xl font-bold text-gray-800">{{ __('admin.edit_page') }} {{ $custom_page->page_name }}</h1>
        ...
        <form action="{{ route('admin.custom-pages.update', $custom_page->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-1">
                    ...
                    <input type="text" name="page_name_bn" id="page_name_bn" value="{{ old('page_name_bn', $custom_page->page_name_bn) }}" placeholder="বাংলায় পৃষ্ঠার নাম"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#3dab8c] focus:border-transparent transition duration-200 outline-none">
                ...
                <div class="space-y-1">
                    ...
                    <input type="text" name="title_bn" id="title_bn" value="{{ old('title_bn', $custom_page->title_bn) }}" placeholder="বাংলায় শিরোনাম"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#3dab8c] focus:border-transparent transition duration-200 outline-none">
                ...
                <div class="space-y-1">
                    ...
                    <input type="text" name="category_bn" id="category_bn" value="{{ old('category_bn', $custom_page->category_bn) }}" placeholder="বাংলায় ক্যাটাগরি"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#3dab8c] focus:border-transparent transition duration-200 outline-none">
                ...
                <div class="space-y-1">
                    ...
                    <input type="text" name="subcategory_bn" id="subcategory_bn" value="{{ old('subcategory_bn', $custom_page->subcategory_bn) }}" placeholder="বাংলায় সাবক্যাটাগরি"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#3dab8c] focus:border-transparent transition duration-200 outline-none">
                ...
                <div class="space-y-1">
                    ...
                    <select name="status" id="status" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#3dab8c] focus:border-transparent transition duration-200 outline-none">
                        <option value="1" {{ old('status', $custom_page->status) ? 'selected' : '' }}>{{ __('admin.active') }}</option>
                        <option value="0" {{ !old('status', $custom_page->status) ? 'selected' : '' }}>{{ __('admin.inactive') }}</option>
                    </select>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-xl p-4 text-center hover:border-[#3dab8c] transition-all bg-gray-50">
                        ...
                        <label for="image" class="cursor-pointer block">
                            ...
                            <p class="mt-1 text-sm text-gray-600 font-medium">{{ __('admin.click_to_change_image') }}</p>
                ...
                <div class="space-y-2">
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-xl p-4 text-center hover:border-[#3dab8c] transition-all bg-gray-50 h-full flex flex-col justify-center">
                        ...
                        <label for="file" class="cursor-pointer block">
                            <div class="mb-2">
                                @if($custom_page->file_path)
                                    <div class="flex items-center justify-center space-x-2 text-xs text-[#3dab8c]">
                                        ...
                                        <span>({{ __('admin.current_status') }} {{ basename($custom_page->file_path) }}</span>
                                    </div>
                                @endif
                            </div>
                            <svg class="mx-auto h-10 w-10 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <p id="fileName" class="mt-1 text-sm text-gray-600 font-medium">{{ __('admin.click_to_change_file') }}</p>
            ...
            <div class="space-y-1">
                ...
                <textarea name="description_bn" id="description_bn" rows="8" placeholder="বাংলায় এই পৃষ্ঠার বিস্তারিত বিষয়বস্তু লিখুন..."
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#3dab8c] focus:border-transparent transition duration-200 outline-none leading-relaxed bn-font">{{ old('description_bn', $custom_page->description_bn) }}</textarea>
