...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <h1 class="text-2xl font-bold text-gray-800">Edit staffVacantPost</h1>
            ...
            <div class="mb-6">
                ...
                @if($staffVacantPost->file_path)
                    <div class="mt-2 mb-2 p-3 bg-gray-50 rounded-md flex items-center justify-between">
                        ...
                        <a href="{{ asset('storage/' . $staffVacantPost->file_path) }}" target="_blank" class="text-xs text-[#3dab8c] hover:text-[#0d3a37] font-medium">View Current</a>
                    </div>
                @endif
            ...
            <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="text-xs text-blue-800">
                        (Created: {{ $staffVacantPost->created_at->format('M d, Y') }})
                    </div>
                </div>
                <p class="mt-2 text-xs text-blue-700">• staff-vacant-posts remain "New" for 7 days after creation.</p>
            </div>
