...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <h1 class="text-2xl font-bold text-gray-800">Create staffVacantPost</h1>
        <a href="{{ route('admin.staff-vacant-posts.index') }}" class="text-gray-500 hover:text-gray-700">Back to List</a>
    </div>

    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form action="{{ route('admin.staff-vacant-posts.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-6">
                <label for="file" class="block text-sm font-medium text-gray-700">staffVacantPost File (PDF or Image)</label>
            ...
            <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <p class="text-sm font-medium text-blue-900 mb-2">staffVacantPost Status Information:</p>
                <ul class="text-xs text-blue-800 space-y-1">
                    <li>• Status is automatically calculated based on creation date</li>
                    <li>• <strong>New</strong>: staff-vacant-posts created within the last 7 days</li>
                    <li>• <strong>Old</strong>: staff-vacant-posts older than 7 days</li>
                    <li>• A "New" badge with animated GIF will appear on the website for new staff-vacant-posts</li>
                </ul>
            </div>
