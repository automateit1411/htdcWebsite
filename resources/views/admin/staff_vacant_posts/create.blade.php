...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <h1 class="text-2xl font-bold text-gray-800">{{ __('admin.create_staff_vacant_post') }}</h1>
        ...
        <form action="{{ route('admin.staff-vacant-posts.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <ul class="text-xs text-blue-800 space-y-1">
                    <li>• {{ __('admin.staff_vacant_post_status_auto') }}</li>
                    <li>• <strong>{{ __('admin.new') }}</strong>: {{ __('admin.staff_vacant_post_new_desc') }}</li>
                    <li>• <strong>{{ __('admin.old') }}</strong>: {{ __('admin.staff_vacant_post_old_desc') }}</li>
                    <li>• {{ __('admin.staff_vacant_post_new_badge') }}</li>
                </ul>
            </div>
