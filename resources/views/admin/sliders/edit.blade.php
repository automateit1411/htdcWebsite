...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-800">{{ __('admin.edit_slider') }}</h1>
            <p class="text-gray-600 mt-1">{{ __('admin.edit_slider_desc') }}</p>
        </div>
            ...
            <div>
                ...
                <div id="selectedImagePreview" {{ !$slider->image_id ? 'class=hidden' : '' }} class="mb-4">
                    ...
                    <p class="mt-2 text-sm text-gray-600 flex items-center gap-1">
                        ...
                        {{ __('admin.image_selected') }} <span id="selectedImageName" class="font-medium">{{ $slider->image ? $slider->image->title : '' }}</span>
                    </p>
                </div>
                ...
                <button type="button" onclick="openImageSelectorModal()" 
                    ...
                    {{ __('admin.change_image_from_gallery') }}
                </button>
                ...
                @enderror
                <p class="mt-2 text-xs text-gray-500">{{ __('admin.click_to_change_image') }}</p>
            </div>
