...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">Add a new image to the homepage slider</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 space-y-6">
            ...
            <div>
                ...
                <div id="selectedImagePreview" class="hidden mb-4">
                    ...
                    <p class="mt-2 text-sm text-gray-600 flex items-center gap-1">
                        ...
                        Image selected: <span id="selectedImageName" class="font-medium"></span>
                    </p>
                </div>
                ...
                @enderror
                <p class="mt-2 text-xs text-gray-500">Click button to choose an image from your gallery</p>
            </div>
            ...
            <div>
                ...
                @error('order')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
                <p class="mt-2 text-xs text-gray-500">Lower numbers appear first. Default is auto-increment.</p>
            </div>
