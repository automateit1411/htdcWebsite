        ...
        <div class="flex flex-col md:flex-row items-center justify-center gap-4 p-1 bg-[#0e3f3c]">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ $settings->youtube_url }}" target="_blank" class="group" aria-label="YouTube">
                    <div class="w-9 h-9 rounded-full bg-[#FF0000] flex items-center justify-center group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-red-500/50 transition-all duration-300 overflow-hidden">
                        <img src="https://images.icon-icons.com/195/PNG/256/YouTube_23392.png" alt="YouTube" class="w-5 h-5 object-contain">
                    </div>
                </a>
                @endif
            </div>
