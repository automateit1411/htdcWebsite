        ...
        <div class="flex flex-col md:flex-row items-center justify-center gap-4 p-1 bg-[#0e3f3c]">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ $settings->facebook_url }}" target="_blank" class="group" aria-label="Facebook">
                    <div class="w-9 h-9 rounded-full bg-[#1877F2] flex items-center justify-center group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300">
