...
<div class="max-w-6xl mx-auto">
    ...
    <div x-data="{ search: '' }">
        ...
        <div class="mb-4 flex justify-between items-center bg-white p-3 rounded shadow border border-gray-100">
            <h2 class="text-lg font-semibold text-gray-700 ml-2">{{ isset($pageTitle) ? $pageTitle : 'All Notices' }}</h2>
            <div class="relative">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    ...
                                    <h3 class="text-lg font-semibold text-gray-700 mb-1">No {{ isset($pageTitle) ? $pageTitle : 'Notices' }} Available</h3>
