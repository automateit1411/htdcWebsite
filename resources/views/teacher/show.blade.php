...
@section('content')
    <div class="p-4 max-w-5xl mx-auto">
        <a href="{{ url('/teacher-information') }}"
            class="inline-flex items-center gap-1 text-sm text-[#0d3a37] hover:text-green-700 mb-4 font-medium">&larr; Back to Teacher
            List</a>
        ...
        <div x-data="{
                ...
                init() {
                    fetch('/proxy/employees/teacher')
                        ...
                        .catch(err => this.error = err.message || 'Unable to load teacher details')
            ...
            <template x-if="loading">
                <div class="flex items-center justify-center py-20">
                    <div class="text-gray-500 text-sm">Loading teacher details...</div>
                </div>
            </template>
