...
<div class="flex items-center justify-center min-h-[calc(100vh-250px)] p-4">
    <div class="w-full max-w-2xl">
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-[#0d3a37]">{{ __('website.employee_login') }}</h1>
            <p class="text-gray-600 mt-2">{{ __('website.select_account_type') }}</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <!-- Teacher Login Card -->
            <a href="{{ config('services.external_api.base_url') }}accounts/login/employee/" target="_blank" class="group">
                <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div class="bg-gradient-to-r from-[#0d3a37] to-[#124b47] p-6 text-center text-white">
                        ...
                        <h2 class="text-2xl font-bold">{{ __('website.teachers_panel') }}</h2>
                        <p class="text-sm mt-2 text-green-100">{{ __('website.login_teacher_credentials') }}</p>
                    </div>
                    <div class="p-6 text-center">
                        ...
                        <p class="text-gray-600 text-sm">{{ __('website.access_teacher_dashboard') }}</p>
                    </div>
                </div>
            </a>
            ...
            <a href="{{ config('services.external_api.base_url') }}accounts/login/employee/" target="_blank" class="group">
                <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div class="bg-gradient-to-r from-[#0d3a37] to-[#124b47] p-6 text-center text-white">
                        ...
                        <h2 class="text-2xl font-bold">{{ __('website.staff_panel') }}</h2>
                        <p class="text-sm mt-2 text-green-100">{{ __('website.login_staff_credentials') }}</p>
                    </div>
                    <div class="p-6 text-center">
                        <div class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-green-100 text-[#3dab8c] mb-4">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <p class="text-gray-600 text-sm">{{ __('website.access_staff_dashboard') }}</p>
                    </div>
                </div>
            </a>
        </div>
