...
@section('content')
    <div class="p-4 max-w-5xl mx-auto">
        <a href="{{ url('/ex-teacher-list') }}"
            class="inline-flex items-center gap-1 text-sm text-[#0d3a37] hover:text-green-700 mb-4 font-medium">&larr; Back to Ex-Teacher
            List</a>
        ...
        <div x-data="{
                ...
                init() {
                    fetch('/proxy/employees/ex-teacher')
                        ...
                        .then(data => {
                            ...
                            if (!found) {
                                this.error = 'Ex-Teacher not found.';
                            } else {
                                this.teacher = found;
                            }
                        })
                        .catch(err => this.error = err.message || 'Unable to load ex-teacher details')
            ...
            <template x-if="loading">
                <div class="flex items-center justify-center py-20">
                    <div class="text-gray-500 text-sm">Loading ex-teacher details...</div>
                </div>
            </template>
                ...
                <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
                    ...
                    <div class="bg-gradient-to-r from-[#0d3a37] to-[#1a6b5a] p-6">
                        <div class="flex flex-col sm:flex-row items-center sm:items-start gap-5">
                            <img :src="teacher.profileScan || 'https://via.placeholder.com/180'" alt="Profile"
                            ...
                            <div class="text-center sm:text-left text-white">
                                <h1 class="text-2xl font-bold" x-text="teacher.name || 'No name'"></h1>
