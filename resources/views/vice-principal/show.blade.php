            ...
            <template x-if="vicePrincipal">
                <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
                            ...
                            <div class="text-center sm:text-left text-white">
                                ...
                                <div class="flex flex-wrap justify-center sm:justify-start gap-2 mt-3">
                                    <span x-show="vicePrincipal.designation_name"
                                        ...
                                        x-text="vicePrincipal.designation_name"></span>
                                    <span x-show="vicePrincipal.department_name"
                                        class="inline-block bg-white/20 text-white text-xs font-medium px-3 py-1 rounded-full"
                                        x-text="vicePrincipal.department_name"></span>
                                    <span x-show="vicePrincipal.category_name"
                                        class="inline-block bg-white/20 text-white text-xs font-medium px-3 py-1 rounded-full"
                                        x-text="vicePrincipal.category_name"></span>
                                </div>
                                <div class="flex flex-wrap justify-center sm:justify-start gap-4 mt-3 text-sm text-green-100">
                                    <span x-show="vicePrincipal.mobile" class="flex items-center gap-1">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                                        <span x-text="vicePrincipal.mobile"></span>
                                    </span>
                                    <span x-show="vicePrincipal.email" class="flex items-center gap-1">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                                        <span x-text="vicePrincipal.email"></span>
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="p-6">
                        ...
                        {{-- Message --}}
                        <template x-if="vicePrincipal.employeeMessage">
                            <div>
                                <div class="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-xl p-5 relative">
                                    ...
                                    <p class="text-sm text-gray-700 leading-relaxed whitespace-pre-line pl-6 italic text-justify" x-text="vicePrincipal.employeeMessage"></p>
                                </div>
                            </div>
                        </template>
                    </div>
