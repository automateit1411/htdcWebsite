    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="mb-6 text-center">
            ...
            <?php if($page->description): ?>
                <p class="text-gray-600 mt-3 max-w-2xl mx-auto"><?php echo e($page->description); ?></p>
            <?php endif; ?>
        </div>
        ...
        <?php if($page->items->count() > 0): ?>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php $__currentLoopData = $page->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden group hover:shadow-2xl hover:border-[#3dab8c] transition-all duration-300">
                        ...
                        <div class="p-5">
                            <?php if($item->title): ?>
                                <h3 class="font-bold text-gray-800 text-lg group-hover:text-[#3dab8c] transition-colors"><?php echo e($item->title); ?></h3>
                            <?php endif; ?>
                            <?php if($item->description): ?>
                                <p class="text-sm text-gray-500 mt-2 leading-relaxed"><?php echo e($item->description); ?></p>
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project Conver\laravelPr\resources\views/custom-page2/show.blade.php ENDPATH**/ ?>