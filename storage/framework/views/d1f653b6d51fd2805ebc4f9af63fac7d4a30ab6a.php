    ...
    <div class="max-w-7xl mx-auto py-1">
        ...
        <div class="text-center mb-1 bg-white shadow">
            ...
            <p class="text-gray-600 max-w-2xl mx-auto">Get in touch with
                <?php echo e($settings->college_name ?? 'Hazera-Taju Degree College'); ?>
        ...
        <div class="relative grid grid-cols-1 lg:grid-cols-2 gap-2 items-start">
                ...
                <div class="bg-gradient-to-r from-[#3dab8c] to-[#0d3a37] p-1 relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-white/90 text-center  flex items-center justify-center gap-2">
                            ...
                            <?php echo e($settings->location ?? 'Chandgaon, Chittagong'); ?>
                    ...
                    <?php if($settings->telephone): ?>
                        <div class="flex items-start gap-4 group">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-gray-600 font-medium text-sm"><?php echo e($settings->telephone); ?></p>
                            </div>
                        </div>
                    <?php endif; ?>

                    <?php if($settings->cell_phone): ?>
                        <div class="flex items-start gap-4 group">
                            <div
                                class="bg-gradient-to-br from-[#3dab8c] to-[#0d3a37] rounded p-3 shadow-lg group-hover:scale-110 transition-transform">
                                <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-gray-600 font-medium text-sm"><?php echo e($settings->cell_phone); ?></p>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($settings->ein): ?>
                        <div class="flex items-start gap-4 group">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-gray-600 font-medium text-sm"><?php echo e($settings->ein); ?></p>
                            </div>
                        </div>
                    <?php endif; ?>

                    <?php if($settings->nu_code): ?>
                        <div class="flex items-start gap-4 group">
                            <div
                                class="bg-gradient-to-br from-[#3dab8c] to-[#0d3a37] rounded p-3 shadow-lg group-hover:scale-110 transition-transform">
                                <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-gray-600 font-medium text-sm"><?php echo e($settings->nu_code); ?></p>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($settings->website): ?>
                        <div class="flex items-start gap-4 group">
                            ...
                            <div class="flex-1">
                                ...
                                <a href="<?php echo e($settings->website); ?>" target="_blank"
                                    class="text-[#3dab8c] hover:text-[#0d3a37] font-semibold transition-colors inline-flex items-center gap-1">
                                    <?php echo e(str_replace(['https://', 'http://', 'www.'], '', $settings->website)); ?>
            ...
            <div
                ...
                <!-- Google Maps Embed -->
                <?php if($settings->google_map_embed): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project Conver\laravelPr\resources\views/contact.blade.php ENDPATH**/ ?>