...
<head>
    ...
    <title>Super Admin Login - HTDC</title>
    ...
    <div class="w-full max-w-md p-1">
        <div class="glass-panel rounded-2xl shadow-2xl overflow-hidden border border-green-100">
            <div class="bg-gradient-to-r from-[#0d3a37] to-[#124b47] p-6 text-center relative overflow-hidden">
                ...
                <div class="relative z-10 flex flex-col items-center">
                    <div class="bg-white p-3 rounded-full shadow-lg mb-4">
                        <img src="<?php echo e(asset('images/logo.svg')); ?>" alt="HTDC Logo" class="h-16 w-16">
                    </div>
                    <h2 class="text-2xl font-bold text-white tracking-wide">Super Admin Login</h2>
                    <p class="text-green-100 text-sm mt-1 opacity-80">Enter your credentials to continue</p>
                </div>
            </div>
            ...
            <div class="p-6">
                ...
                <form method="POST" action="<?php echo e(route('super-admin.login.submit')); ?>" class="space-y-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" id="email"
                                ...
                                placeholder="info@htdc.edu.bd" required autofocus value="<?php echo e(old('email', 'info@htdc.edu.bd')); ?>">
                        </div>
                    </div>
            ...
            <div class="bg-gray-50 px-8 py-4 border-t border-gray-100 text-center">
                <a href="<?php echo e(url('/')); ?>" class="text-xs font-medium text-gray-500 hover:text-[#0d3a37] transition inline-flex items-center justify-center">
...
<?php /**PATH D:\Project Conver\laravelPr\resources\views/admin/auth/super-login.blade.php ENDPATH**/ ?>