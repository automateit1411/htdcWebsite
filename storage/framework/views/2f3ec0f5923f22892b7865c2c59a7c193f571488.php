        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 ">
                ...
                <?php if($sliders->count() > 0): ?>
                    ...
                    <section x-data="{ 
                                                                                                                            activeSlide: 0, 
                                                                                                                            slides: <?php echo e(json_encode($slidesData)); ?>,
                                                                                                                            timer: null, 
                                                                                                                            init() { 
                                                                                                                                this.startTimer(); 
                                                                                                                            }, 
                ...
                <section class="bg-white rounded-lg shadow-md p-2">
                    <div class="flex flex-col sm:flex-row gap-4 items-center">
                        ...
                        <div class="w-full sm:w-1/3 h-36">
                            <?php if($setting && $setting->about_image_id): ?>
                                <?php
                                    $aboutImage = \App\Models\Gallery::find($setting->about_image_id);
                                ?>
                                <img src="<?php echo e($aboutImage ? asset('storage/' . $aboutImage->image) : asset('images/Bannerbuilding.jpeg')); ?>"
                                    alt="About College" class=" shadow w-full   md:h-36 lg:h-36 h-36 sm:h-36 object-cover">
                            <?php else: ?>
                                <img src="<?php echo e(asset('images/Bannerbuilding.jpeg')); ?>" alt="College Building"
                        ...
                        <div class="w-full sm:w-2/3  text-justify">
                            <h3 class="text-lg font-bold text-gray-800 mb-2 hidden">
                                <?php echo e($setting?->about_title ?? 'About Hazera-Taju Degree College'); ?>

                            </h3>
                            <p class="text-gray-700 text-sm leading-relaxed mb-1">
                                <?php echo e(Str::limit(strip_tags($setting?->about_description ?? 'Hazera-Taju Degree College is committed to providing quality education in a non-political environment with modern facilities.'), 300)); ?>

                            </p>
                            <a href="<?php echo e(route('dynamic.page', 'about')); ?>"
                ...
                <div class="space-y-1">
                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
                        <div class="p-1">
                            <div class="flex items-center gap-3 mb-3">
                                <!-- Rounded Image -->
                                <?php if($setting && $setting->founder_image): ?>
                                    <img src="<?php echo e(asset('storage/' . $setting->founder_image)); ?>"
                                        alt="<?php echo e($setting->founder_name ?? 'Founder'); ?>"
                                        class="w-24 h-24 rounded-full object-cover border-3 border-[#3dab8c] shadow">
                                <?php else: ?>
                                    <img src="<?php echo e(asset('images/logo.svg')); ?>" alt="Founder"
                                        class="w-24 h-24 rounded-full object-cover border-3 border-[#3dab8c] shadow">
                                <?php endif; ?>
                                <div>
                                    <h3 class="text-base font-bold text-gray-800">
                                        <?php echo e($setting?->founder_name ?? 'Founder Name'); ?>

                                    </h3>
                                    <p class="text-xs text-gray-600"><?php echo e($setting?->founder_title ?? 'Founder'); ?></p>
                                </div>
                            </div>
                            <p class="text-gray-700 text-xs leading-relaxed mb-3">
                                <?php echo e(Str::words($setting?->founder_message ?? 'Visionary leader who established this institution with a mission to provide quality education.', 10, '...')); ?>

                            </p>
                            <a href="<?php echo e(route('founder')); ?>"
                                class="inline-block bg-[#0d3a37] text-white px-4 py-1.5 rounded text-xs font-medium hover:bg-green-800 transition">
                                See More
                            </a>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
                        <div class="p-1">
                            <div class="flex items-center gap-3 mb-3">
                                <!-- Rounded Image -->
                                <?php if($setting && $setting->principal_image): ?>
                                    <img src="<?php echo e(asset('storage/' . $setting->principal_image)); ?>"
                                        alt="<?php echo e($setting->principal_name ?? 'Principal'); ?>"
                                        class="w-24 h-24 rounded-full object-cover border-3 border-[#3dab8c] shadow">
                                <?php else: ?>
                                    <img src="<?php echo e(asset('images/logo.svg')); ?>" alt="Principal"
                                        class="w-24 h-24 rounded-full object-cover border-3 border-[#3dab8c] shadow">
                                <?php endif; ?>
                                <div>
                                    <h3 class="text-base font-bold text-gray-800">
                                        <?php echo e($setting?->principal_name ?? 'Principal Name'); ?>

                                    </h3>
                                    <p class="text-xs text-gray-600"><?php echo e($setting?->principal_title ?? 'Principal'); ?></p>
                                </div>
                            </div>
                            <p class="text-gray-700 text-xs leading-relaxed mb-3">
                                <?php echo e(Str::words($setting?->principal_message ?? 'Dedicated to maintaining academic excellence and fostering innovation.', 10, '...')); ?>
                    ...
                    <div class="flex items-center justify-between gap-3">
                        <div class="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <p class="text-2xl font-bold"><?php echo e(number_format($totalVisitors)); ?></p>
                            </div>
                        </div>
                        <div class="border-l border-white/30 pl-3">
                            <p class="text-xs opacity-90 mb-1">Today</p>
                            <p class="text-xl font-bold"><?php echo e(number_format($todayVisitors)); ?></p>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project Conver\laravelPr\resources\views/welcome.blade.php ENDPATH**/ ?>