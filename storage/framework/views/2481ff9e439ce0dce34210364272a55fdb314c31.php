...
<div class="min-h-[60vh] flex items-center justify-center py-8 px-4">
    <div class="bg-white rounded-2xl shadow-xl border border-emerald-100 max-w-lg w-full p-8 text-center relative overflow-hidden">
        ...
        <div class="flex flex-col sm:flex-row gap-3 justify-center mt-6">
            <a href="<?php echo e(url('/')); ?>" class="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-[#3dab8c] to-[#0d3a37] text-white font-medium px-6 py-2.5 rounded-xl shadow hover:opacity-90 transition-all text-sm">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project Conver\laravelPr\resources\views/errors/404.blade.php ENDPATH**/ ?>