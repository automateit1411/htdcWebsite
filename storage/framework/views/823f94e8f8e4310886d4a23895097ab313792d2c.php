...
<?php $__env->startSection('content'); ?>
    <div class="space-y-8">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Welcome back, <?php echo e(Auth::user()->name); ?>. Here's what's happening today.</p>
        </div>
            ...
            <div class="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['total_teachers']); ?></p>
                    </div>
                </div>
            ...
            <div class="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['total_notices']); ?></p>
                    </div>
                </div>
                <div class="mt-4 flex items-center text-sm text-[#3dab8c] font-medium">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project Conver\laravelPr\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>