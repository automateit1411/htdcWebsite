...
<div class="space-y-6" x-data="{ search: '' }">
    <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        <a href="<?php echo e(route('admin.website-links.create')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-[#3dab8c] hover:bg-[#0d3a37] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#3dab8c] whitespace-nowrap">
            Add Link
        </a>
    </div>
        ...
        <div class="h-[calc(100vh-250px)] overflow-y-auto pr-1 overflow-x-auto relative custom-scrollbar">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors" x-show="search === '' || '<?php echo e(strtolower($link->name)); ?>'.includes(search.toLowerCase())">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900"><?php echo e($link->name); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <a href="<?php echo e($link->url); ?>" target="_blank" class="text-sm text-blue-600 hover:text-blue-800 flex items-center gap-1 max-w-xs truncate">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <form action="<?php echo e(route('admin.website-links.toggle-status', $link->id)); ?>" method="POST" class="inline-block">
                                <?php echo csrf_field(); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="<?php echo e(route('admin.website-links.edit', $link->id)); ?>" class="text-[#3dab8c] hover:text-[#0d3a37] mr-3 font-semibold">Edit</a>
                            <form action="<?php echo e(route('admin.website-links.destroy', $link->id)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Are you sure?');">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project Conver\laravelPr\resources\views/admin/website-links/index.blade.php ENDPATH**/ ?>