        ...
        <div x-data="{
                ...
                init() {
                    fetch('/proxy/employees/teacher')
                        ...
                        .catch(err => this.error = err.message || 'Unable to load teachers')
            ...
            <div class="flex items-center gap-3 mb-4">
                <h1 class="text-xl font-bold text-gray-800">Teacher Information</h1>
            ...
            <template x-if="loading">
                <div class="flex items-center justify-center py-20">
                    <div class="text-gray-500 text-sm">Loading teachers...</div>
                </div>
            </template>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project Conver\laravelPr\resources\views/teacher/index.blade.php ENDPATH**/ ?>