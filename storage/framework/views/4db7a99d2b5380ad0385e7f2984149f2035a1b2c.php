    ...
    <div class="w-full max-w-md p-1">
        <div class="glass-panel rounded-2xl shadow-2xl overflow-hidden border border-green-100">
            ...
            <div class="p-6">
                ...
                <form method="POST" action="<?php echo e(route('super-admin.otp.verify')); ?>" class="space-y-6">
                    <?php echo csrf_field(); ?>
                ...
                <div class="mt-6 text-center">
                    <a href="<?php echo e(route('super-admin.login')); ?>" class="text-sm text-[#3dab8c] hover:text-[#0d3a37] font-medium">
                        ← Back to Login
                    </a>
                </div>
            </div>
...
<?php /**PATH D:\Project Conver\laravelPr\resources\views/admin/auth/super-otp.blade.php ENDPATH**/ ?>